...
export default async function Home() {
  ...
  return (
    <main className="flex flex-col justify-center p-10 space-y-5 relative">
      <Chart chartData={allData} dailyData={dailyData} />
      ...
      <Button
        className="sticky bottom-12 right-auto mr-auto w-12 h-12 rounded-full border-2 bg-white dark:bg-black"
        variant="link"
        asChild
      >
        <a
          href="https://github.com/marcelo-schreiber/indoor-weather-logger"
          target="_blank"
